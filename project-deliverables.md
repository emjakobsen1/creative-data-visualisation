...
During the first days, I had difficulties finding the right data set which led to a lot of deroutes. Working out and trying some different directions for the project, I realized a lot of potential problems that could arise due to scalability as these sets where huge. Some of these explorations can be seen here: (1. Set of seedlings converted to SVG. 2. Coral reeves locations (x,y) and bleach level within the Indo-Pacific). 
